...
const siteConfig = {
  ...
  headerIcon: 'img/brainwhite.png',
  footerIcon: 'img/brainwhite.png',
  favicon: 'img/brainwhite.png',

  /* Colors for website */
  colors: {
    primaryColor: '#605ca3',
    secondaryColor: '#331240',
  },
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Newton Web`,
